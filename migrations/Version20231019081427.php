 ...
 */
final class Version20231019081427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE videos CHANGE video_id video_id VARCHAR(50) NOT NULL, CHANGE video_title video_title VARCHAR(100) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE videos CHANGE video_id video_id VARCHAR(30) NOT NULL, CHANGE video_title video_title VARCHAR(30) NOT NULL');
    }
}
